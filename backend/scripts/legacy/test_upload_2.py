...
async def main():
    ...
    print("Uploading mpremote_api.py...")
    success, err = await session_manager.upload_file("n1780913184722", node, "/app/backend/scripts/mpremote_api.py", "/tmp/nr_scripts/mpremote_api.py")
