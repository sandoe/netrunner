...
async def deploy_beacon_to_node(
    ip, username, password, target_server_ip, csi_mode, sample_rate, udp_port, node_id
):
    def run_ssh():
        ...
        try:
            ...
            ssh.exec_command(
                "nohup python3 /tmp/netrunner_beacon.py > /tmp/beacon.log 2>&1 &"
            )
