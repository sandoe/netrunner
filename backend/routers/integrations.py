...
async def test_integration(integration_id: str):
    ...
    print(f"[WEBHOOK SIMULATION] Sent payload to {integration['provider']} at {integration['url']}")
    return {"status": "success", "message": f"Test payload sent to {integration['provider']}"}
